...
from .views import (createPatient, patientDetails, updatePatient,
                    ...
                    patientDetailsAjax, updatePatientAjax)
...
urlpatterns = [
    ...
    path('detail/', patientDetailsAjax, name="ajax-patient-detail-page"),
    path('edit/', updatePatientAjax, name="ajax-patient-update-page"),
]
